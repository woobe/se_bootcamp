...
train = h2o.importFile("./examples/regression/house_price_train.csv")
test = h2o.importFile("./examples/regression/house_price_test.csv")
...
features = setdiff(colnames(train), "medv")
target = "medv"
